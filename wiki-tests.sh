...
wget -O - -q http://wiki.apertium.org/wiki/French_and_Portuguese/$TESTTYPE | cleansrc > $SRCLIST;
wget -O - -q http://wiki.apertium.org/wiki/French_and_Portuguese/$TESTTYPE | cleantrg > $TRGLIST;
